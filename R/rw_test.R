...
out1 = stan(file = "stan/rw_improper_with_data.stan", data = stan.data.noconstraint)
out2 = stan(file = "stan/rw_soft_constraint_with_data.stan", data = stan.data.withconstraint)
out3 = stan(file = "stan/rw_hard_constraint_with_data.stan", data = stan.data.withconstraint)
